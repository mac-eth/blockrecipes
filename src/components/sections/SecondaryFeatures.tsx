...
const SecondaryFeatures: React.FC = () => {
  return (
    ...
    >
      <svg
        className="absolute inset-0 -z-10 bg-neutral-50 h-full w-full stroke-neutral-200 [mask-image:radial-gradient(100%_100%_at_top_right,neutral-50,transparent)]"
        aria-hidden="true"
      >
        <defs>
          <pattern
      ...
      <Container>
        ...
        >
          {features.map((feature) => (
            <li
              key={feature.name}
              className="rounded-2xl border border-neutral-300 bg-neutral-100 shadow-sm z-10 p-8 hover:border-red-600 hover:shadow-lg hover:brightness-95 duration-500"
            >
